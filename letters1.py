...
def generate_letter_point(which_letter, height, current, points_distance = 2):
        ...
        if which_letter == 'A':
            ...
            i = 0
            while i < 360:
                points2.append((radius * math.cos(i * math.pi / 180), radius * math.sin(i * math.pi / 180)))
                i = i + theta
            #points2 = []
            ...
            current = current + height + height / 10
            return points, current
            ...
            current = current + int(0.15 * height) + height / 20 + height / 10
            return points, current
            ...
            maxi = max(points2, key = lambda item: item[1])[1]
            ...
            i = 0
            while i < width / 2:
                points1.append((width / 2 - i, height + i * 3.03 - height / 2))
                points1.append((width / 2 + i, height + i * 3.03 - height / 2))
                points1.append((width / 2 - i, height - i * 3.03 - height / 2))
                points1.append((width / 2 + i, height - i * 3.03 - height / 2))
